...
public class DatabaseHandler extends SQLiteOpenHelper {
   ...
   public DatabaseHandler(Context context){
    ...
    public void onCreate(SQLiteDatabase db) {
        //create table
        String CREATE_TABLE = "CREATE TABLE " + Constants.TABLE_NAME + "(" + Constants.KEY_ID + " INTEGER PRIMARY KEY, " + Constants.FOOD_NAME + " TEXT, " + Constants.FOOD_CALORIES_NAME + " INT, " + Constants.DATE_NAME + " LONG);";
    ...
    //return all calories user has entered
    ...
    public void addFood(Food food) {
        ...
        Log.v("Added Food item", "Good to go!!");
        dba.close();
    ...
    public ArrayList<Food> getFoods(){
        ...
        Cursor cursor = dba.query(Constants.TABLE_NAME, new String[]{Constants.KEY_ID, Constants.FOOD_NAME, Constants.FOOD_CALORIES_NAME, Constants.DATE_NAME}, null, null, null, null, Constants.DATE_NAME + " DESC ");
